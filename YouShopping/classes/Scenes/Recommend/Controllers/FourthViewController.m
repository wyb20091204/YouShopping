...
#import <MJRefresh.h>
@interface FourthViewController ()<UITableViewDelegate,UITableViewDataSource,FirstTableViewCellDelegate>
...
- (void)requestData
{
    ...
    [[FristAllRequest shareAllRequest]requestFourthSuccess:^(NSDictionary *dic) {
