...
#import <MJRefresh.h>
@interface ThirdViewController ()<UITableViewDelegate,UITableViewDataSource,FirstTableViewCellDelegate>
...
- (void)requestData
{
    ...
    [[FristAllRequest shareAllRequest]requestThirdSuccess:^(NSDictionary *dic) {
