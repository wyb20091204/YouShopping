...
#import <MJRefresh.h>
@interface EighthViewController ()<UITableViewDelegate,UITableViewDataSource,FirstTableViewCellDelegate>
...
- (void)requestData
{
   ...
   [[FristAllRequest shareAllRequest]requestEighthSuccess:^(NSDictionary *dic) {
