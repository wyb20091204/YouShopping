...
#import <MJRefresh.h>
@interface EleventhViewController ()<UITableViewDelegate,UITableViewDataSource,FirstTableViewCellDelegate>
...
- (void)requestData
{
    ...
    [[FristAllRequest shareAllRequest]requestEleventhSuccess:^(NSDictionary *dic) {
