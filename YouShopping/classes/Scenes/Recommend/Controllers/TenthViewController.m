...
#import <MJRefresh.h>
@interface TenthViewController ()<UITableViewDelegate,UITableViewDataSource,FirstTableViewCellDelegate>
...
- (void)requestData
{
    ...
    [[FristAllRequest shareAllRequest]requestTenthSuccess:^(NSDictionary *dic) {
