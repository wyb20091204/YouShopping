...
#import <MJRefresh.h>
@interface SixthViewController ()<UITableViewDelegate,UITableViewDataSource,FirstTableViewCellDelegate>
...
- (void)requestData
{
    ...
    [[FristAllRequest shareAllRequest]requestSixthSuccess:^(NSDictionary *dic) {
