...
#import <MJRefresh.h>
@interface FourteenthViewController ()<UITableViewDelegate,UITableViewDataSource,FirstTableViewCellDelegate>
...
- (void)requestData
{
    ...
    [[FristAllRequest shareAllRequest]requestFourteenthSuccess:^(NSDictionary *dic) {
