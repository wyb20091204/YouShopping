...
#import <MJRefresh.h>
@interface ThirteenthViewController ()<UITableViewDelegate,UITableViewDataSource,FirstTableViewCellDelegate>
...
- (void)requestData
{
    ...
    [[FristAllRequest shareAllRequest]requestThirteenthSuccess:^(NSDictionary *dic) {
