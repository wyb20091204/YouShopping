...
#import <MJRefresh.h>
@interface SecondViewController ()<UITableViewDelegate,UITableViewDataSource,FirstTableViewCellDelegate>
...
- (void)requestData
{
    ...
    [[FristAllRequest shareAllRequest]requestSecondSuccess:^(NSDictionary *dic) {
