...
#import <MJRefresh.h>
@interface NinethViewController ()<UITableViewDelegate,UITableViewDataSource,FirstTableViewCellDelegate>
...
- (void)requestData
{
    ...
    [[FristAllRequest shareAllRequest]requestNinethSuccess:^(NSDictionary *dic) {
