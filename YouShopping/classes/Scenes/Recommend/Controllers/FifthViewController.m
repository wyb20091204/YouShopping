...
#import <MJRefresh.h>
@interface FifthViewController ()<UITableViewDelegate,UITableViewDataSource,FirstTableViewCellDelegate>
...
- (void)requestData
{
    ...
    [[FristAllRequest shareAllRequest]requestFifthSuccess:^(NSDictionary *dic) {
