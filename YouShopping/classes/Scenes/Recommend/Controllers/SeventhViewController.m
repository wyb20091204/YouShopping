...
#import <MJRefresh.h>
@interface SeventhViewController ()<UITableViewDelegate,UITableViewDataSource,FirstTableViewCellDelegate>
...
- (void)requestData
{
    ...
    [[FristAllRequest shareAllRequest]requestSeventhSuccess:^(NSDictionary *dic) {
