...
#import <MJRefresh.h>
@interface SixteenthViewController ()<UITableViewDelegate,UITableViewDataSource,FirstTableViewCellDelegate>
...
@implementation SixteenthViewController
...
- (void)requestData
{
    ...
    [[FristAllRequest shareAllRequest]requestSixteenthSuccess:^(NSDictionary *dic) {
