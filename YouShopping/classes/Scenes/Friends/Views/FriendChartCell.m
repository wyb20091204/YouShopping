...
@implementation FriendChartCell
...
- (void)setChartMessage:(ChartMessage *)chartMessage{
    ...
    _headerImageView.frame = CGRectMake(10, 10, 45, 45);
    _headerImageView.image = [UIImage imageNamed:@"addHeaderP"];
    
    _contentImgView.image = [UIImage imageNamed:@"chatfrom_bg_normal"];
    //  设置气泡拉伸
    ...
    _contentImgView.frame = CGRectMake(CGRectGetMaxX(_headerImageView.frame) + 10,
                                       10,
                                       chartMessage.frame.size.width + 35,
                                       chartMessage.frame.size.height + 25);
    
    _contentLabel.frame = CGRectMake(CGRectGetMinX(_contentImgView.frame) + 20,
                                     20,
